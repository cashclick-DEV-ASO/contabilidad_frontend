...
export class Componente {
    ...
    constructor(elemento = null, { clase = "", id = "", hijos = null } = {}) {
        ...
        this.estilos = {
            ...
            estilo3: COMPONENTE.ESTILO_3,
            estilo4: COMPONENTE.ESTILO_4
        }
    ...
    setEstilo(estilo, remEstilo = "") {
        Object.values(this.estilos).forEach((e) => this.removeClase(e))
        if (remEstilo !== "") this.removeClase(remEstilo)
        this.estilo = estilo
    ...
    setEstilo1() {
        return this.setEstilo(this.estilos.estilo1)
    }

    setEstilo2() {
        return this.setEstilo(this.estilos.estilo2)
    }

    setEstilo3() {
        return this.setEstilo(this.estilos.estilo3)
    }

    setEstilo4() {
        return this.setEstilo(this.estilos.estilo4)
    }
